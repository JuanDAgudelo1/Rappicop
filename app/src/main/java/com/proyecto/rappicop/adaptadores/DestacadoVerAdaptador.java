...
public class DestacadoVerAdaptador extends RecyclerView.Adapter<DestacadoVerAdaptador.ViewHolder> {

    List<DestacadoVerModelo> list;

    public DestacadoVerAdaptador(List<DestacadoVerModelo> list) {
        this.list = list;
    }
